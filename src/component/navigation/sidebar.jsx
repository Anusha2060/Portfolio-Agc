...
function Sidebar({Sidebarshow}) {
  return (
    <div>
        <div className={`h-screen w-44 ${Sidebarshow?"translate-x-0":"translate-x-48"} transition-all duration-700 ease-in-out delay-100 bg-white text-black font-medium fixed lg:hidden top-0 right-0`}>
